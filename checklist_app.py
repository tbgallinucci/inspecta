...
def show_reports():
    ...
    # Verificar se foi direcionado de um checklist específico
    if 'ir_para_relatorio' in st.session_state:
        selected_checklist = st.session_state.ir_para_relatorio
        del st.session_state.ir_para_relatorio
